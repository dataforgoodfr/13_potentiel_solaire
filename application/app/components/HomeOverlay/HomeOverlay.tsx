...
export default function HomeOverlay() {
	...
	return (
		<div className='absolute inset-0 z-40 flex h-full w-full flex-col items-center justify-start bg-blue/80 p-4'>
			...
			<div className='w-full max-w-screen-xl pb-6 pt-4'>
				<h1 className='mb-24 inline-block font-verdana text-[28px] font-normal leading-normal tracking-sm text-slate-100'>
					Découvrez le
					<br />
