...
import { footerLinks } from './components/content/footer';
import { navBarLinks } from './components/content/navBar';
...
function footerSitemapElements(): MetadataRoute.Sitemap {
	const filteredFooterLinks = footerLinks.filter((link) => link.href && link.href.startsWith("/"));
...
function navBarSitemapElements(): MetadataRoute.Sitemap {
	const filteredNavBarLinks = navBarLinks.filter((link) => link.href && link.href.startsWith("/"));
